...
class BaseTask(gym.Env):
    ...
    def __init__(self, cfg, sim_params, physics_engine, sim_device, headless):
        ...
        self.legs_torque_lim_buff = torch.zeros(self.num_envs, device=self.device, dtype=torch.bool)
        self.arm_torque_lim_buff = torch.zeros(self.num_envs, device=self.device, dtype=torch.bool)      
