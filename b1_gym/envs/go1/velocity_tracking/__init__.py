...
class VelocityTrackingEasyEnv(LeggedRobot):
    def __init__(self, sim_device, headless, num_envs=None, prone=False, deploy=False,
        ...
        # if cfg.viewer.virtual_screen_capture:
        #     # import os
        #     from pyvirtualdisplay.smartdisplay import SmartDisplay
        #     self.virtual_display = SmartDisplay(visible=True, size=(300, 300), manage_global_env=False, backend='xvfb')
        #     self.virtual_display.start()
        #     print(self.virtual_display.display)
        #     import os
        #     os.environ['DISPLAY'] = f':4'
