...
class Ball(Asset):
    ...
    def initialize(self):
        ...
        asset = self.env.gym.create_sphere(self.env.sim, ball_radius, asset_options)
    ...
    def get_ang_vel(self):
        return quat_rotate_inverse(self.env.base_quat, self.env.root_states[self.env.object_actor_idxs, 10:13])